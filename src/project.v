...
module tt_um_italu (
    ...
    always @* begin
        ...
        /*
         * Alternate between 0 and 1 so both logic values
         * are explicitly sensitized.
         */
        ...
        if (!rst_n) begin
            ...
            case (bist_state)
                ...
                BIST_EXEC: begin
                    ...
                    /*
                     * MISR only uses the ALU result, preserving
    ...
    always @(posedge clk or negedge rst_n) begin
        ...
        if (!rst_n) begin
            ...
            // Execute current serial instruction.
